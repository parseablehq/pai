...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodMetricsConfig) DeepCopyInto(out *PodMetricsConfig) {
	*out = *in
	in.NamespaceSelector.DeepCopyInto(&out.NamespaceSelector)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodMetricsConfig.
func (in *PodMetricsConfig) DeepCopy() *PodMetricsConfig {
	if in == nil {
		return nil
	}
	out := new(PodMetricsConfig)
